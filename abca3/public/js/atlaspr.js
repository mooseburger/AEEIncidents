...
.methods({
          ...
          .enter()
            .append("path")  
              ...
              .attr("class", tile)
               ...
               .attr("extra-data",function(d){
                if(d.properties.DD){
                  alert(d.properties.DD);
                  return d.properties.DD;
                }
                return '';
                })
  ...
  _update: function(){
    ...
    self.svg.selectAll(".markers").attr("cx", function(d){
      debugger;
      return self.projection(self.center_ll)[0];
      })
      .attr("cy", function(d){return self.projection(self.center_ll)[1]})
  },
})
